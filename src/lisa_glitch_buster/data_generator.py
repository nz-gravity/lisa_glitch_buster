...
from .constants import TOBS, DT, N, TIMES, FREQS, SENSITIVITY_MATRIX
...
class Data:
    def __init__(self, seed=None, Tobs=TOBS, dt=DT):
        ...
        self.analysis = AnalysisContainer(self.simulated_data, SENSITIVITY_MATRIX, signal_gen=waveform)
    ...
    def plot_injection(self, ax=None):
        ...
        ax.set_xlim(self.injection_params['start'] - 10, fred_end_time(**self.injection_params) + 10)
        ax.legend()
        return ax
